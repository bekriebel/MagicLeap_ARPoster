...
namespace MagicLeap
{
    ...
    public class VideoSystemLauncher : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Rotation offset of the object relative to Reference Transform")]
        ...
        /// <summary>
        /// Calculate and return the rotation which the video player system should look at
        /// </summary>
        /// <returns>The absolute rotation of the new target</returns>
